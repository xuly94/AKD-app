...
# User selects which content to display
    ...
    with col1:
        if st.button("Model Introduction"):
            selected_content = "Model Introduction"
    
    with col2:
        if st.button("AKD and CKD Prediction"):
            selected_content = "AKD and CKD Prediction"

    # Apply CSS to style the buttons
    st.markdown(
        """
        <style>
        .widget-button {
